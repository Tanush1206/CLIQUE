    ...
    <div className="flex flex-col min-h-screen bg-white text-black overflow-x-hidden">
      ...
      <main className="flex-grow w-full flex flex-col items-center">
        <div className="w-full max-w-4xl mx-auto px-4 pt-24 text-center">
          ...
          <Link to="/login" className="px-6 py-3 bg-black text-white rounded-[100px] font-semibold text-lg hover:bg-gray-800 transition-colors relative z-10">
  Log In
</Link>
          <Link
            to="/home"
            className="px-6 py-3 bg-gray-200 rounded-[100px] font-medium text-black flex items-center gap-2 hover:bg-gray-300 transition-colors"
          >
            See our Events <span className="text-xl">→</span>
          </Link>
        </div>
